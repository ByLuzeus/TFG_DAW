...
<div id="micontent" class="shown">
  ...
  <div class="properties index large-9 medium-8 columns content">
    <div id="panel_header">
      <h3><?= __('Tipos de notificación') ?></h3>
        ...
        <tbody>
          <?php foreach ($notifications as $notif): ?>
            <tr data-tableid="<?= h($notif->id) ?>">
              ...
              <td><?= h($notif->id) ?></td>
              <td><?php echo ($notif->description); ?></td>
              <td><a href="/notifications/edit/<?= h($notif->id) ?>"><span class="hidden-xs">Editar</span><i
