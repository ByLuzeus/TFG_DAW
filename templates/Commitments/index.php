  ...
  <div class="properties index large-9 medium-8 columns content">
    ...
    <div class="container-full-tabla">
      <table id="eventos" class="stripe" cellpadding="0" cellspacing="0">
        ...
        <tbody>
          <?php foreach ($commitments as $com): ?>
            <tr data-tableid="<?= h($com->id) ?>">
              <td class="ordercol">
              ...
              <td><?= h($com->id) ?></td>
              <td><?= h($com->commitmenttype->description) ?></td>
              <td><?php echo ($com->description); ?></td>
              <td><a href="/commitments/edit/<?= h($com->id) ?>"><span class="hidden-xs">Editar</span><i
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form method="post" action="/commitments/delete">
