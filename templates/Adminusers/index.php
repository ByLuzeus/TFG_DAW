...
<div id="micontent" class="shown">
  ...
  <div class="properties index large-9 medium-8 columns content">
    <div id="panel_header">
      <h3><?= __('Usuarios administradores') ?></h3>
      <div id="action-buttons">
        <a id="action-add" href="/adminusers/add" class="link-action"><span class="hidden-xs">Añadir</span><i
            class="material-icons visible-xs-block">add</i></a>
        <a id="action-edit" class="link-action unactive"><span class="hidden-xs">Editar</span><i
            class="material-icons visible-xs-block">edit</i></a>
        <a id="action-del" data-toggle="modal" data-target="#modalEliminar" class="link-action dellink unactive"><span
            class="hidden-xs">Eliminar</span><i class="material-icons visible-xs-block">delete</i></a>
      </div>
    </div>
        ...
        <tbody>
          <?php foreach ($users as $user): ?>
            <tr data-tableid="<?= h($user->id) ?>">
              ...
              <td><a href="/users/view/<?= h($user->id) ?>"><span class="hidden-xs">Ver +</span><i
                    class="material-icons visible-xs-block">link</i></a></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form method="post" action="/adminusers/delete">
