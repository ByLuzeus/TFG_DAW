  ...
  <div class="properties index large-9 medium-8 columns content">
    ...
    <div class="container-full-tabla">
      <table id="eventos" class="stripe" cellpadding="0" cellspacing="0">
        ...
        <tbody>
          <?php foreach ($rewardsconsequencestypes as $rewtype): ?>
            <tr data-tableid="<?= h($rewtype->id) ?>">
              <td class="ordercol">
              ...
              <td><?= h($rewtype->description) ?></td>
              <td><?php echo ($rewtype->points); ?></td>
              <td><a href="/rewardsconsequencestypes/edit/<?= h($rewtype->id) ?>"><span class="hidden-xs">Editar</span><i
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form method="post" action="/rewardsconsequencestypes/delete">
