  ...
  <div class="properties index large-9 medium-8 columns content">
    ...
    <div class="container-full-tabla">
      <table id="eventos" class="stripe" cellpadding="0" cellspacing="0">
        ...
        <tbody>
          <?php foreach ($commitmenttypes as $comtype): ?>
            <tr data-tableid="<?= h($comtype->id) ?>">
              <td class="ordercol">
              ...
              <td><?= h($comtype->id) ?></td>
              <td><?php echo ($comtype->description); ?></td>
              <td><a href="/commitmenttypes/edit/<?= h($comtype->id) ?>"><span class="hidden-xs">Editar</span><i
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form method="post" action="/commitmenttypes/delete">
