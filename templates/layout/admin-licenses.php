...
<?= $this->Html->script('https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.8.4/moment.min.js') ?>
<?= $this->Html->script('https://cdn.datatables.net/plug-ins/1.10.16/sorting/datetime-moment.js') ?>
...
<?= $this->Html->scriptBlock('
    $(document).ready(function(){
      $.fn.dataTable.moment( "D/M/YY H:mm" );
      var table3=$("#eventos").DataTable({
        ...
        "order": [[ 0, "des" ]],
        "columnDefs": [
        //  { "order": false, "targets": -1 }
        { responsivePriority: 1, targets: 0 },
        { responsivePriority: 1, targets: 1 },
        { targets: -1, className:"not-mobile" }
        ],
        language: {
