...
<?= $this->Html->scriptBlock('
    function addNetwork(){
      ...
      var newDisc = "<div class=\"row row-network\"><div class=\"col-lg-4 col-md-4\"><p class=\"dato-titulo\">"+lanet+"</p><input type=\"hidden\" name=\"networks_ids[]\" id=\"networks_ids\"  value=\""+netId+"\"></div><div class=\"col-lg-4 col-md-4\"><p class=\"dato-titulo\">"+neturl+"</p><input type=\"hidden\" name=\"networks_urls[]\" id=\"networks_urls\" value=\""+neturl+"\"></div><div class=\"col-lg-2 col-md-2\"><button style=\"bottom:0px;\" id=\"deleterow\"type=\"button\" class=\"btn btn-danger btn-disc btn-disc-del\">Eliminar</button></div></div>";
