...
class NotificationsController extends AppController
{
    ...
    public function beforeFilter(\Cake\Event\EventInterface $event)
    {
        ...
        $menuadmin = $this->cell('Menuadmin', ['def_notiftypes']);
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            $notification = $this->Notifications->patchEntity($notification, $this->request->getData());
            if ($this->Notifications->save($notification)) {
                $this->Flash->success(__('El tipo de notificación se ha actualizado correctamente.'));
                return $this->redirect(['action' => 'index']);
            }
            $this->Flash->error(__('No se pudo actualizar el tipo de notificación. Por favor, revisa el campo obligatorio.'));
        }
